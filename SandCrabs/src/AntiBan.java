...
//            System.out.println("idle");
    ...
    @Override
    public void execute() {
//        System.out.println(ctx.players.local().tile().compareTo(sandCrabSpot));
//    System.out.println(sandCrabSpot.distanceTo(ctx.players.local().tile()));
//        if (ctx.input.getLocation().getX() < 100) {
//            ctx.input.move(new Point((int) ctx.input.getLocation().getX() + 100, (int)ctx.input.getLocation().getY()));
//        }
//        else if (ctx.input.getLocation().getX() > ctx.widgets.component(122, 0).width()-100) {
//            ctx.input.move(new Point((int) ctx.input.getLocation().getX() - 100, (int)ctx.input.getLocation().getY()));
//        }
//        if (ctx.input.getLocation().getY() < 100) {
//            ctx.input.move(new Point((int) ctx.input.getLocation().getX(), (int)ctx.input.getLocation().getY()+ 100));
//        }
//        else if (ctx.input.getLocation().getY() > ctx.widgets.component(122, 0).height()-100) {
//            ctx.input.move(new Point((int) ctx.input.getLocation().getX(), (int)ctx.input.getLocation().getY()- 100));
//        }
...
//        System.out.println(Math.pow(-1, rand.nextInt(2)));
//        System.out.println(rand_int + " " + rand_int1);
        if (rand.nextBoolean()) {
            if (rand_chance <= 1) {
                if (rand.nextInt(3) == 0) {
                ...
                if (rand.nextInt(1) == 1) {
                    ...
                    ctx.widgets.component(320, 2).hover();
